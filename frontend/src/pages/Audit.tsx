        ...
        {step === 'unlocked' && audit && (
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 text-center">
              ...
              <p className="text-xs text-gray-500 mb-4">SuperLocalSEO schedules daily ranking checks, periodic review imports and monthly citation checks. Monthly reports summarize collected observations and suggested checks; they do not establish why rankings changed.</p>
              <Link
