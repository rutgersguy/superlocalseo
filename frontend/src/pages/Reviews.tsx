...
function SyncBLButton({ onSynced }: { onSynced: () => void }) {
  ...
  return (
    <button onClick={() => void handleSync()} disabled={syncing}
      className="whitespace-nowrap px-1.5 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm font-medium text-slate-600 border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors disabled:opacity-50">
