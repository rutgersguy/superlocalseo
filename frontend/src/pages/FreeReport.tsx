  ...
  return <div className="free-report"><header><Link to="/" className="fr-brand">SuperLocalSEO</Link><span>Local visibility report</span></header><main>
    ...
    {!id ? <>
      ...
      {s && <>
        ...
        {['failed', 'rejected', 'uncertain', 'sending', 'legacy_unknown'].includes(report?.emailStatus ?? '') && <p className="fr-no-print">Email delivery was not confirmed. You can bookmark this report or print it.</p>}
