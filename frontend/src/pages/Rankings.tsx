      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-lg border transition-colors ${showKeywords ? 'bg-brand-500 text-white border-brand-500' : 'text-slate-600 border-slate-200 hover:bg-slate-50'}`}
          >
            Keywords
          </button>
          <button
            onClick={() => setShowRoi((v) => !v)}
            className={`px-4 py-2 text-sm font-medium rounded-lg border transition-colors ${showRoi ? 'bg-brand-500 text-white border-brand-500' : 'text-slate-600 border-slate-200 hover:bg-slate-50'}`}
          >
            ROI
          </button>
          <button
