...
const points=Array.from({length:9},(_,i)=>({lat:33.762909+(i-4)*0.001,lng:-84.422675,status:i===8?'unavailable':'checked',rank:i===0?2:null,resultCount:i===8?0:12,checkedAt:at,collectedAt:at,items:i===0?[{placeId:'fixture',name:'Fixture business',rank:2}]:[]}));
