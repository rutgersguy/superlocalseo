...
Updated September 10, 2026. Provider-mapping release: [PR #218](https://github.com/rutgersguy/superlocalseo/pull/218). Its deployment acceptance record is on the PR; the preceding verified production release was `de435e0` ([PR #217](https://github.com/rutgersguy/superlocalseo/pull/217)). This is the current status index; dated investigation documents preserve earlier observations and are not current launch checklists.
